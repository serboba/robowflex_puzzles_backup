...
*/
 ...
 //   b.addPlanner(std::make_shared<geometric::LBTRRT>(builder.ss->getSpaceInformation()));
    ...
    std::string db_output = "db_files/"+robot_name+".db";

    std::string output = "python ompl_benchmark_statistics.py " + result_filename + " -d " + db_output;
