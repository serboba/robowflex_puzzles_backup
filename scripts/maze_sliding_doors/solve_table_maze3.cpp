//
// Created by serboba on 04.01.22.
//
...
int main(int argc, char **argv)
{
    ...
    auto maze_dart = darts::loadMoveItRobot("maze2",
                                            "/home/serboba/rb_ws/devel/lib/robowflex_dart/table_maze3.urdf",
                                            "/home/serboba/rb_ws/devel/lib/robowflex_dart/table_maze3.srdf");
    ...
    const auto &plan_solution_all = [&]() {
        ...
        builder.addGroup(maze_name, "cube_gr2"); // ADD ALL GROUPS THAT ARE NEEDED
        ...
        goal_spec.setPose(1.41, 0.05, 0.86, 1, 0 ,0 ,0);            //  SET WANTED CUBE POSITION
       ...
       // rrt->setRange(0.1);
        ...
        if (solved)
        {
            ...
            window.animatePath(builder, builder.getSolutionPath(false),5,15);
